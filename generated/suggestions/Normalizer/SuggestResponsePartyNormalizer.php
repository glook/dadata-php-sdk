...
class SuggestResponsePartyNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Glook\Dadata\Generated\Suggestions\Model\SuggestResponseParty' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Glook\Dadata\Generated\Suggestions\Model\SuggestResponseParty' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        $object = new SuggestResponseParty();
        ...
        if (\array_key_exists('suggestions', $data) && null !== $data['suggestions']) {
            ...
            foreach ($data['suggestions'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Glook\Dadata\Generated\Suggestions\Model\SuggestionParty', 'json', $context);
            }
