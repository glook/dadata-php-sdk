...
class GeoLocateOutward extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;
    protected $name;

    public function __construct(string $name, GeoLocateOutwardRequest $requestBody)
    {
        $this->name = $name;
    ...
    {
        return str_replace(['{name}'], [$this->name], '/api/4_1/rs/geolocate/{name}');
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof GeoLocateOutwardRequest) {
