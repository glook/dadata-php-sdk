...
class SuggestBank extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(SuggestBankRequest $requestBody)
    {
    ...
    {
        return '/api/4_1/rs/suggest/bank';
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof SuggestBankRequest) {
