...
class FindAffiliatedParty extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(FindAffiliatedPartyRequest $requestBody)
    {
    ...
    {
        return '/api/4_1/rs/findAffiliated/party';
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof FindAffiliatedPartyRequest) {
