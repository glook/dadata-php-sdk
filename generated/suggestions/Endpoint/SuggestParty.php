...
class SuggestParty extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(SuggestPartyRequest $requestBody)
    {
    ...
    {
        return '/api/4_1/rs/suggest/party';
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof SuggestPartyRequest) {
