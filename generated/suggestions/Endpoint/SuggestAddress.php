...
class SuggestAddress extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(SuggestAddressRequest $requestBody)
    {
    ...
    {
        return '/api/4_1/rs/suggest/address';
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof SuggestAddressRequest) {
