...
class FindByIdAddress extends BaseEndpoint implements Endpoint
{
    use EndpointTrait;

    public function __construct(FindAddressByIdRequest $requestBody)
    {
    ...
    {
        return '/api/4_1/rs/findById/address';
    }

    public function getBody(SerializerInterface $serializer, $streamFactory = null): array
    {
        if ($this->body instanceof FindAddressByIdRequest) {
