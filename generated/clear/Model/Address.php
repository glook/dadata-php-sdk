...
class Address
{
     ...
     * @var null|string
     */
    protected $planningStructureFiasId;

    /**
     * @var null|string
     */
    protected $planningStructureKladrId;

    /**
     * @var null|string
     */
    protected $planningStructureWithType;

    /**
     * @var null|string
     */
    protected $planningStructureType;

    /**
     * @var null|string
     */
    protected $planningStructureTypeFull;
    ...
    public function getPlanningStructureFiasId(): ?string
    {
        return $this->planningStructureFiasId;
    }

    public function setPlanningStructureFiasId(?string $planningStructureFiasId): self
    {
        $this->planningStructureFiasId = $planningStructureFiasId;

        return $this;
    }

    public function getPlanningStructureKladrId(): ?string
    {
        return $this->planningStructureKladrId;
    }

    public function setPlanningStructureKladrId(?string $planningStructureKladrId): self
    {
        $this->planningStructureKladrId = $planningStructureKladrId;

        return $this;
    }

    public function getPlanningStructureWithType(): ?string
    {
        return $this->planningStructureWithType;
    }

    public function setPlanningStructureWithType(?string $planningStructureWithType): self
    {
        $this->planningStructureWithType = $planningStructureWithType;

        return $this;
    }

    public function getPlanningStructureType(): ?string
    {
        return $this->planningStructureType;
    }

    public function setPlanningStructureType(?string $planningStructureType): self
    {
    ...
    public function getPlanningStructureTypeFull(): ?string
    {
        return $this->planningStructureTypeFull;
    }

    public function setPlanningStructureTypeFull(?string $planningStructureTypeFull): self
    {
        $this->planningStructureTypeFull = $planningStructureTypeFull;

        return $this;
    }

    public function getPlanningStructure(): ?string
    {
        return $this->planningStructure;
    }

    public function setPlanningStructure(?string $planningStructure): self
    {
    ...
    {
        return $this->steadKladrId;
    }

    public function setSteadKladrId(?string $steadKladrId): self
    {
        $this->steadKladrId = $steadKladrId;
    ...
    public function setQcGeo(?int $qcGeo): self
    {
        $this->qcGeo = $qcGeo;
    ...
    public function setQcComplete(?int $qcComplete): self
    {
    ...
    public function setQcHouse(?int $qcHouse): self
    {
