...
class AddressNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return 'Glook\Dadata\Generated\Clear\Model\Address' === $type;
    }

    public function supportsNormalization($data, $format = null)
    {
        return is_object($data) && 'Glook\Dadata\Generated\Clear\Model\Address' === get_class($data);
    }
    ...
    public function denormalize($data, $class, $format = null, array $context = [])
    {
        ...
        if (\array_key_exists('stead_kladr_id', $data) && null !== $data['stead_kladr_id']) {
            $object->setSteadKladrId($data['stead_kladr_id']);
        } elseif (\array_key_exists('stead_kladr_id', $data) && null === $data['stead_kladr_id']) {
            $object->setSteadKladrId(null);
        }
        ...
        if (\array_key_exists('metro', $data) && null !== $data['metro']) {
            $values = [];
            foreach ($data['metro'] as $value) {
                $values[] = $this->denormalizer->denormalize($value, 'Glook\Dadata\Generated\Clear\Model\Metro', 'json', $context);
            }
            $object->setMetro($values);
        ...
        if (\array_key_exists('divisions', $data) && null !== $data['divisions']) {
            $object->setDivisions($this->denormalizer->denormalize($data['divisions'], 'Glook\Dadata\Generated\Clear\Model\AddressDivisions', 'json', $context));
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        if (null !== $object->getSteadKladrId()) {
            $data['stead_kladr_id'] = $object->getSteadKladrId();
        }
        ...
        if (null !== $object->getMetro()) {
            $values = [];
            foreach ($object->getMetro() as $value) {
